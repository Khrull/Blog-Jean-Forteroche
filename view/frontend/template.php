    ...
    <!-- HEADER -->
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                { ?>
                <li><i class="fas fa-user"></i><a href="index.php?action=deconnexion"> Se déconnecter</a></li>
                <?php }
                else {?>
                <li><i class="fas fa-user"></i><a href="index.php?action=btnSeConnecter"> Se connecter</a></li>
                <?php }?>
